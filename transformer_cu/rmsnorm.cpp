...
// 	mm2s_input_data(s_weights, weights, ratio, CURR_LAYER, offset);
// 	new_rmsnorm(c_rms, s_tokens_out, s_abs_out, s_diff, internal_tokens, s_weights, INIT);
// 	rms_max_finder(max_val, s_abs_out);
// 	rms_quant_out(s_sf, s_w, s_tokens_out, max_val, c_rms);
// 	return;
// }