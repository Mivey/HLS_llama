...
void GeMV_kernel(hls::stream<my_float_t> &out, hls::stream<my_float_t>  &tok_sf, s_idata_v_t &tok_q, mfdata_v_t *w_sf, idata_v_t *w, const int N_DIM, const int M_DIM, const int CURR_LAYER, const int W_Off, const int sf_reg, const int w_reg);
...
// void GeMV_PE_sum(hls::stream<float_t> &out, hls::stream<float_t> &qin, hls::stream<float_t> &sfin, const int N_DIM, const int M_DIM){
